...
func _shoot_at_player() -> void:
	...
	spin_tween.tween_property($EnemyModel, "rotation:x", $EnemyModel.rotation.x + TAU, 0.9)
...
func _on_area_entered(_area: Area3D) -> void:
	# Ignoruj trafienia gdy węzeł już jest usuwany (double-hit w tej samej klatce)
